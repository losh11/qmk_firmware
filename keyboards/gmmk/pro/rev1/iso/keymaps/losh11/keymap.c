...
//      ESC      F1       F2       F3       F4       F5       F6       F7       F8       F9       F10      F11      F12	     §             Rotary(Mute)
...
//      Win_L    Alt_L    Ct_L                                SPACE                               Ct_R    FN        Alt_R    Left     Down     Right
    ...
    [0] = LAYOUT(
        KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  UC(0xa7),         KC_MUTE,
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
    if (host_keyboard_led_state().caps_lock) {
        ...
        rgb_matrix_set_color(68, RGB_SPRINGGREEN);
        rgb_matrix_set_color(71, RGB_SPRINGGREEN);
        rgb_matrix_set_color(74, RGB_SPRINGGREEN);
        rgb_matrix_set_color(77, RGB_SPRINGGREEN);
        rgb_matrix_set_color(81, RGB_SPRINGGREEN);
        rgb_matrix_set_color(84, RGB_SPRINGGREEN);
        rgb_matrix_set_color(88, RGB_SPRINGGREEN);
        rgb_matrix_set_color(92, RGB_SPRINGGREEN);
        // turn on all right-side LEDs
        rgb_matrix_set_color(69, RGB_SPRINGGREEN);
        rgb_matrix_set_color(72, RGB_SPRINGGREEN);
        rgb_matrix_set_color(75, RGB_SPRINGGREEN);
        rgb_matrix_set_color(78, RGB_SPRINGGREEN);
        rgb_matrix_set_color(82, RGB_SPRINGGREEN);
        rgb_matrix_set_color(85, RGB_SPRINGGREEN);
        rgb_matrix_set_color(89, RGB_SPRINGGREEN);
        rgb_matrix_set_color(93, RGB_SPRINGGREEN);
    }
    return false;
}
